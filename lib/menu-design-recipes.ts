...
const RESTAURANT_MENU_RECIPES: MenuDesignRecipe[] = [
  {
    ...
    directive: `Concept: Clean A4 menu layout with a warm, appetizing color scheme. Header with restaurant name and logo prominently displayed. Arrange items in a grid that fits the EXACT number of uploaded items — no more, no fewer. Each item gets a generous photo section with name below and price in a bold badge.
...
Mood: Professional, appetizing, classic restaurant menu.`,
  ...
  },
  {
    ...
    menuCategory: "restaurant",
    directive: `Concept: Clean, modern A4 menu with generous white space. Light background (off-white or very light cream). Items displayed in a clean grid (sized to fit EXACTLY the uploaded item count) with circular or rounded-square food photos. Minimal typography with a single accent color.
...
Mood: Trendy, minimal, cafe-style elegance.`,
  ...
  },
  {
    ...
    menuCategory: "restaurant",
    directive: `Concept: Energetic promotional menu with bold colors and dynamic layout. Arrange items in a grid that fits the EXACT number of uploaded items — no more, no fewer. Bold price callouts with starburst or badge shapes.
...
const SUPERMARKET_MENU_RECIPES: MenuDesignRecipe[] = [
  {
    ...
    directive: `Concept: Bold retail product flyer. Large store name headline at the top with eye-catching graphics. Arrange products in a grid that fits the EXACT number of uploaded items — no more, no fewer. Each product has a circular or rectangular frame with the price in a bold red or yellow badge.
...
Mood: Energetic, retail, eye-catching product catalog. Only show discount/sale elements if old prices are provided by the user.`,
  ...
  },
  {
    ...
    menuCategory: "supermarket",
    directive: `Concept: Clean grocery catalog with fresh, natural feel. Light green or white background. Arrange products in a grid that fits the EXACT number of uploaded items — no more, no fewer. Clean white cards with prices in green or red badges. Fresh leaf or produce decorative accents.
...
Mood: Fresh, clean, trustworthy grocery.`,
  ...
  },
  {
    ...
    menuCategory: "supermarket",
    directive: `Concept: Classic product showcase flyer layout. Header with store name prominently displayed. Arrange products in a grid that fits the EXACT number of uploaded items — no more, no fewer. Each product has a dedicated card with photo, name, and price clearly displayed.
