    ...
    const templates = [
      // 1. Modern Dark Sale (Neon/Cyberpunk vibes) - High contrast, impactful
      {
        ...
        layers: [
          ...
          { id: "subtitle", type: "text" as const, label: "Subtitle", labelAr: "العنوان الفرعي", x: 0.1, y: 0.72, width: 0.8, height: 0.05, rotation: 0, zIndex: 3, visible: true, locked: false, props: { content: "خصومات تصل إلى 70٪", fontFamily: "Noto Kufi Arabic", fontSize: 28, fontWeight: "bold", color: "#a78bfa", align: "center", direction: "rtl", maxLines: 1, editable: true, binding: "productName" } },
      ...
      // 3. Modern Food (Clean/Appetizing) - Warm colors, organic shapes
      {
        ...
        layers: [
          ...
          { id: "price", type: "text" as const, label: "Price", labelAr: "السعر", x: 0.1, y: 0.82, width: 0.35, height: 0.08, rotation: 0, zIndex: 3, visible: true, locked: false, props: { content: "45 ر.س", fontFamily: "Noto Kufi Arabic", fontSize: 40, fontWeight: "extrabold", color: "#dc2626", align: "center", direction: "rtl", maxLines: 1, editable: true, binding: "price" } },
      ...
      // 6. Vibrant General (Pop Art/Bold) - Gradient background, white text
      {
        ...
        layers: [
          ...
          { id: "price", type: "text" as const, label: "Price", labelAr: "السعر", x: 0.2, y: 0.72, width: 0.6, height: 0.08, rotation: 0, zIndex: 2, visible: true, locked: false, props: { content: "50٪ خصم", fontFamily: "Noto Kufi Arabic", fontSize: 48, fontWeight: "extrabold", color: "#fef08a", align: "center", direction: "rtl", maxLines: 1, editable: true, binding: "price" } },
      ...
      // 7. Minimal White (Professional/Corporate)
      {
        ...
        layers: [
          ...
          { id: "price", type: "text" as const, label: "Price", labelAr: "السعر", x: 0.3, y: 0.8, width: 0.4, height: 0.06, rotation: 0, zIndex: 2, visible: true, locked: false, props: { content: "120 ر.س", fontFamily: "Noto Kufi Arabic", fontSize: 32, fontWeight: "bold", color: "#18181b", align: "center", direction: "rtl", maxLines: 1, editable: true, binding: "price" } },
        ]
      },
