...
const PARTNER_NAV = [
  ...
  { href: "/partner/users", label: "المستخدمون", icon: Users },
] as const;
...
export default function PartnerLayout({
  ...
  const { error: accessError, isLoading: isAccessLoading } = useSWR(
    isSignedIn ? "/api/partner/overview" : null,
    fetcher
  );
      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="bg-surface-1 border border-card-border rounded-2xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-muted mb-6">
            يرجى تسجيل الدخول للوصول إلى لوحة الشركاء.
          </p>
          <Link
            href="/sign-in"
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="bg-surface-1 border border-card-border rounded-2xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-muted mb-6">
            ليس لديك صلاحية الوصول إلى لوحة الشركاء. تواصل مع المسؤول للحصول
            على الصلاحية.
          </p>
          <Link
            href="/"
    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="p-6 border-b border-card-border">
          ...
          <p className="text-xs text-muted mt-1">تتبع إحالاتك وأدائك</p>
        </div>
